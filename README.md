...
## Development environment and release process
 ...
 - create virtualenv with Flask and Flask System Info installed into it (latter is installed in
...
install it (`pip install flaskSysInfo.tar.gz`), ensure that configuration file exists and
`FLASKSYSINFO_SETTINGS` environment variable points to it, ensure that user has access to the
